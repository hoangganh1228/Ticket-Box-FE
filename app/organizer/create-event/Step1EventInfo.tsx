...
export default function EnhancedEventForm({
  ...
  const {
    ...
    onProvinceNameChange: (name) =>
      handleFieldChange("province", name, setProvince),
    onDistrictNameChange: (name) =>
      handleFieldChange("district", name, setDistrict),
  ...
  return (
    <div className="space-y-6 bg-gray-900 text-white p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <ImageUpload
              ...
              onChange={(file) =>
                handleFieldChange("thumbnail", file, setThumbnail || (() => {}))
              }
          ...
          <div>
            <ImageUpload
              ...
              value={banner || null}
              onChange={(file) =>
                handleFieldChange("banner", file, setBanner || (() => {}))
              }
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div className="relative">
          <input
            ...
            value={eventName}
            onChange={(e) =>
              handleFieldChange("eventName", e.target.value, setEventName)
            }
            onBlur={() => handleBlur("eventName")}
            placeholder="Tên sự kiện"
            className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${getBorderClass(
              "eventName",
              "border-gray-600"
            )}`}
          />
        ...
        <div className="space-y-3">
          <label className="flex items-center cursor-pointer">
            <input
              ...
              onChange={(e) =>
                handleFieldChange("eventType", e.target.value, setEventType)
              }
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div className="relative">
          <input
            ...
            value={venueName}
            onChange={(e) =>
              handleFieldChange("venueName", e.target.value, setVenueName)
            }
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className={`w-full px-4 py-3 bg-gray-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent appearance-none ${getBorderClass(
                  "province",
                  "border-gray-600"
                )}`}
              >
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        ...
        <div
          className={`border rounded-lg bg-white ${getBorderClass(
            "description",
            "border-gray-600"
          )}`}
        >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  value={orgName}
                  onChange={(e) =>
                    handleFieldChange("orgName", e.target.value, setOrgName)
                  }
                  onBlur={() => handleBlur("orgName")}
                  placeholder="Tên ban tổ chức"
                  maxLength={80}
                  className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent ${getBorderClass(
                    "orgName",
                    "border-gray-300"
                  )}`}
                />
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  maxLength={500}
                  rows={4}
                  className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none ${getBorderClass(
                    "orgDescription",
                    "border-gray-300"
                  )}`}
                />
